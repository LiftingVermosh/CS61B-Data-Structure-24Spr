...
public class ArrayDeque61B<T> implements Deque61B<T> {
    ...
    private int up2power(int inputSize){
        int size = 1;
...
//        @SuppressWarnings("unchecked")
        public T next(){
            if (!hasNext()) {
                ...
                T res =  array[curElement];
                curElement = (curElement + 1) & (size - 1);
                ++this.eleRetured;
                return res;
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        ArrayDeque61B<?> that = (ArrayDeque61B<?>)o;
